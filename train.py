...
parser.add_argument('--mask_root', type=str, default='./data')
...
parser.add_argument('--save_model_interval', type=int, default=80)
parser.add_argument('--vis_interval', type=int, default=90)
...
for i in tqdm(range(start_iter, args.max_iter)):
    ...
    if (i + 1) % args.vis_interval == 0:
        ...
        evaluate(model, dataset_val, device,
                 '{:s}/images/test1_{:d}.jpg'.format(args.save_dir, i + 1))
